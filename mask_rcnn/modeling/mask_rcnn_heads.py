...
from mask_rcnn.modeling import ResNet
...
class mask_rcnn_outputs(nn.Module):
    ...
    def __init__(self, dim_in):
        ...
        # TODO: check if use number of actor classes
        n_classes = cfg.MODEL.NUM_ACTOR_CLASSES if cfg.MRCNN.CLS_SPECIFIC_MASK else 1
