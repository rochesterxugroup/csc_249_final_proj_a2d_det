...
from mask_rcnn.utils.collections import AttrDict
...
# See model_configs/test_time_aug/e2e_mask_rcnn_R-50-FPN_2x.yaml for an example
# ---------------------------------------------------------------------------- #
...
# model_configs/test_time_aug/keypoint_rcnn_R-50-FPN_1x.yaml
# ---------------------------------------------------------------------------- #
...
__C.MODEL.NUM_ACTOR_CLASSES = 8
__C.MODEL.NUM_ACTION_CLASSES = 10
...
# ------------------------------added for A2D dataset------------------------- #

__C.A2D = AttrDict()

# number of optical flows = SEGMENT_LENGTH in training
__C.A2D.SEGMENT_LENGTH = 4
# load optical flow or compute on the fly
__C.A2D.LOAD_FLOW = False
# clip the optical flow field within the magnitude in range [-FLOW_MAX_MAG, FLOW_MAX_MAG], this is enable if CLIP_FLOW_MAG is True
__C.A2D.FLOW_MAX_MAG = 20
# whether clip magnitude of flow
__C.A2D.CLIP_FLOW_MAG = False
# data root
__C.A2D.ROOT = None
# flow root
__C.A2D.FLOW_ROOT = None
# whether use metric learning
